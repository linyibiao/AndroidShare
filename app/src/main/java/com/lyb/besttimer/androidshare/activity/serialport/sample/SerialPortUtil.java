...
import com.lyb.besttimer.serialport.SerialPortFinder;
...
public class SerialPortUtil {
    ...
    public SerialPort getSerialPort(Context context) throws SecurityException, IOException, InvalidParameterException {
        if (mSerialPort == null) {
            ...
            SharedPreferences sp = context.getSharedPreferences("com.lyb.besttimer.androidshare_preferences", Context.MODE_PRIVATE);
